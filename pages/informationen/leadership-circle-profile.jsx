  ...
  return (
    <Layout>
        <div className='main-container'>
            ...
            <Quote text={"Jede der Ebenen enthält eine beachtliche Menge an Informationen und geht auch über Ihre Führungskompetenzen hinaus."} />
