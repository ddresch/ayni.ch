...
export default function LandingPage({ frontmatter, markdown}) {
  return (<>
      ...
      <Layout>
        ...
        {frontmatter.boxHeadline != '' && <ContentContainer shapeType={'quads2'} primaryColor={'#faedcd'}>
              <div className='spacer-top'></div>
              <Headline 
...
export async function getStaticProps() {
  const fileContent = matter(fs.readFileSync(`./content/allgemein/datenschutz.md`, 'utf8'), {
